    ...
    return (
        <div>
            <nav className="sb-topnav navbar navbar-expand navbar-dark bg-dark">
                ...
                <a className="navbar-brand ps-3" href="/dashboard">Translation Request</a>
                ...
                <ul className="navbar-nav ms-auto ms-md-0 me-3 me-lg-4">
                    <li className="nav-item dropdown">
                        ...
                        <ul className="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                            ...
                            <li><a className="dropdown-item" id="btn-logout">Logout</a></li>
                        </ul>
                    </li>
                </ul>
            </nav>
                    ...
                    <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                        <div class="sb-sidenav-menu">
                            <div class="nav">
                                ...
                                <a class="nav-link" href="..\..\pages/dashboard/tables.html">
                                    <div class="sb-nav-link-icon"><i class="fas fa-tachometer-alt"></i></div>
                                    Dashboard
                                </a>
                                <a class="nav-link" href="../create/index.html">
                                ...
                                <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne"
                                    ...
                                    <nav class="sb-sidenav-menu-nested nav">
                                        <a class="nav-link" href="../layout/layout-static.html">Static
                                            Navigation</a>
                                        <a class="nav-link" href="../layout/layout-sidenav-light.html">Light
                                            Sidenav</a>
                                    </nav>
                                </div>
                                <a class="nav-link collapsed" href="#" data-bs-toggle="collapse"
                                    ...
                                    <nav class="sb-sidenav-menu-nested nav accordion" id="sidenavAccordionPages">
                                        ...
                                        <div class="collapse" id="pagesCollapseAuth" aria-labelledby="headingOne"
                                            ...
                                            <nav class="sb-sidenav-menu-nested nav">
                                                ...
                                                <a class="nav-link" href="../login/password.html">Forgot
                                                    Password</a>
                                            </nav>
                                        </div>
                                        <a class="nav-link collapsed" href="#" data-bs-toggle="collapse"
